...
export const MissionSection = ({ stats, isLoading }) => (
  ...
  <div className="relative bg-white/40 dark:bg-slate-800/40 rounded-2xl p-4 sm:p-6 md:p-8 lg:p-12 mb-8 sm:mb-12 md:mb-16 shadow-xl border border-white/50 dark:border-slate-700/50 backdrop-blur-md overflow-hidden">

    <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6 relative z-10">

      <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-full flex items-center justify-center text-white shadow-lg">

        <GraduationCap className="w-5 h-5 sm:w-6 sm:h-6" />

      </div>

      <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-slate-900 dark:text-white">Наша миссия</h2>

    </div>

    

    <p className="text-sm sm:text-base md:text-lg text-slate-600 dark:text-slate-400 leading-relaxed mb-6 sm:mb-8 relative z-10">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 relative z-10">
      ...
      <div className="text-center p-4 sm:p-6 bg-emerald-50/80 dark:bg-emerald-900/20 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-emerald-200/50 dark:border-emerald-700/50">

        <div className="text-xl sm:text-2xl md:text-3xl font-bold text-emerald-600 dark:text-emerald-400 mb-2">
        ...
        <div className="text-xs sm:text-sm md:text-base text-slate-600 dark:text-slate-400">Студентов используют</div>
      ...
      <div className="text-center p-4 sm:p-6 bg-emerald-50/80 dark:bg-emerald-900/20 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-emerald-200/50 dark:border-emerald-700/50">
        ...
        <div className="text-xs sm:text-sm md:text-base text-slate-600 dark:text-slate-400">Факультетов охвачено</div>

      </div>

      <div className="text-center p-4 sm:p-6 bg-emerald-50/80 dark:bg-emerald-900/20 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-emerald-200/50 dark:border-emerald-700/50 sm:col-span-2 lg:col-span-1">
        ...
        <div className="text-xs sm:text-sm md:text-base text-slate-600 dark:text-slate-400">Время доступности</div>
...
export const CTASection = ({ setActiveTab }) => (
  ...
  <div className="mt-8 sm:mt-12 md:mt-16">
    ...
    <div className="relative bg-white/40 dark:bg-slate-800/40 rounded-2xl p-4 sm:p-6 md:p-8 lg:p-12 shadow-xl border border-white/50 dark:border-slate-700/50 backdrop-blur-md overflow-hidden mb-8 sm:mb-12 md:mb-16">

      <div className="text-center relative z-10">

        <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-3 sm:mb-4 text-slate-900 dark:text-white">Присоединяйтесь к нам!</h2>

        <p className="text-sm sm:text-base md:text-lg text-slate-600 dark:text-slate-400 mb-6 sm:mb-8 max-w-2xl mx-auto px-4">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 px-4">
          ...
          <button 
            ...
            className="px-6 sm:px-8 py-3 sm:py-4 bg-[#0088cc] hover:bg-[#0077b3] text-white rounded-2xl sm:rounded-3xl font-bold transition-all hover:-translate-y-1 flex items-center gap-2 shadow-lg text-sm sm:text-base"
    ...
    <div className="text-center px-4">
      ...
      <button 
        ...
        className="group relative inline-flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-3 bg-white/40 dark:bg-slate-800/40 hover:bg-white/50 dark:hover:bg-slate-800/50 text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300 rounded-xl sm:rounded-2xl font-medium transition-all duration-300 hover:shadow-lg hover:-translate-y-1 border border-emerald-200/50 dark:border-emerald-700/50 backdrop-blur-sm overflow-hidden text-sm sm:text-base"
