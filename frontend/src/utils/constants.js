...
export const features = [
  {
    ...
    description: 'Просматривайте расписание занятий в удобном формате с возможностью фильтрации по типам занятий.'
  },
  {
    icon: 'BookOpen',
    title: 'Библиотека материалов',
    description: 'Доступ к учебным материалам, лекциям и дополнительной литературе в одном месте.'
  },
  {
    icon: 'User',
    title: 'Персонализация',
    description: 'Адаптивный интерфейс с темной/светлой темой и персональными настройками.'
  },
  {
    icon: 'Download',
    title: 'Офлайн доступ',
    description: 'Возможность скачать материалы для офлайн просмотра и синхронизация при подключении.'
  }
];
